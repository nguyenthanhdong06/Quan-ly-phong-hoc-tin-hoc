...
export default function ComputerReportTab({ currentUser }: ComputerReportTabProps) {
  ...
  const generateOfficialHTML = (isWord: boolean = false) => {
    const containerStyle = isWord 
      ? "font-family: 'Times New Roman', Times, serif; color: black; line-height: 1.3; background: white; font-size: 10.5pt;"
      : "font-family: 'Times New Roman', Times, serif; color: black; line-height: 1.3; padding-top: 2cm; padding-bottom: 2cm; padding-left: 3cm; padding-right: 2cm; max-width: 21cm; margin: 0 auto; background: white; font-size: 10.5pt; box-sizing: border-box;";
    return `
      <div style="${containerStyle}" class="official-doc-content">
        <!-- ĐẦU TRANG -->
        <table style="width: 100%; border: none; border-collapse: collapse; margin-bottom: 12px;">
          <tr>
            <td style="width: 45%; text-align: center; vertical-align: top; padding: 0;">
              <div style="font-size: 9.5pt; font-weight: bold; text-transform: uppercase; color: black;">UBND XÃ LONG ĐỊNH</div>
              <div style="font-size: 9.5pt; font-weight: bold; text-transform: uppercase; text-decoration: underline; text-underline-offset: 3px; text-decoration-thickness: 1.2px; color: black; margin-top: 1px;">TRƯỜNG TH LONG ĐỊNH</div>
            </td>
            <td style="width: 55%; text-align: center; vertical-align: top; padding: 0;">
              <div style="font-size: 9.5pt; font-weight: bold; text-transform: uppercase; color: black;">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</div>
              <div style="font-size: 9.5pt; font-weight: bold; margin-top: 1px; color: black;">Độc lập - Tự do - Hạnh phúc</div>
              <div style="width: 110px; border-bottom: 1.2px solid black; margin: 4px auto 0 auto;"></div>
            </td>
          </tr>
        </table>

        <!-- TIÊU ĐỀ CHÍNH -->
        <div style="text-align: center; font-size: 13pt; font-weight: bold; text-transform: uppercase; margin: 12px 0 12px 0; letter-spacing: 0.3px; color: black;">
          ${(generalInfo.tieuDeBaoCao || 'BÁO CÁO CƠ SỞ VẬT CHẤT PHÒNG MÁY TÍNH').toUpperCase()}
        </div>

        <!-- I. THÔNG TIN CHUNG -->
        <div style="font-size: 10.5pt; font-weight: bold; margin-top: 10px; margin-bottom: 4px; color: black;">
          I. Thông tin chung
        </div>
        <table style="width: 100%; border: none; border-collapse: collapse; font-size: 10pt; margin-bottom: 12px; color: black;">
          <tr style="height: 20px;">
            <td style="width: 180px; padding: 1px 0; font-weight: normal;">Đơn vị:</td>
            <td style="border-bottom: 1px dotted #666; padding: 1px 4px; font-weight: bold;">${generalInfo.donVi}</td>
          </tr>
          <tr style="height: 20px;">
            <td style="padding: 1px 0; font-weight: normal;">Địa phương:</td>
            <td style="border-bottom: 1px dotted #666; padding: 1px 4px;">${generalInfo.diaPhuong}</td>
          </tr>
          <tr style="height: 20px;">
            <td style="padding: 1px 0; font-weight: normal;">Người phụ trách phòng máy:</td>
            <td style="border-bottom: 1px dotted #666; padding: 1px 4px; font-weight: bold;">${generalInfo.nguoiPhuTrach}</td>
          </tr>
          <tr style="height: 20px;">
            <td style="padding: 1px 0; font-weight: normal;">Thời gian báo cáo:</td>
            <td style="border-bottom: 1px dotted #666; padding: 1px 4px;">${generalInfo.thoiGianBaoCao}</td>
          </tr>
        </table>

        <!-- II. HIỆN TRẠNG PHÒNG MÁY -->
        <div style="font-size: 10.5pt; font-weight: bold; margin-top: 12px; margin-bottom: 4px; color: black;">
          II. Hiện trạng phòng máy
        </div>
        <table style="width: 100%; border: 1px solid black; border-collapse: collapse; font-size: 9.5pt; color: black; margin-bottom: 12px; page-break-inside: avoid;">
          <thead>
            <tr style="background-color: #f2f2f2; font-weight: bold; text-align: center; height: 24px;">
              <th style="border: 1px solid black; width: 35px; padding: 3px 2px;">STT</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px; width: 145px;">Hạng mục</th>
              <th style="border: 1px solid black; width: 55px; padding: 3px 2px;">Tổng số</th>
              <th style="border: 1px solid black; width: 75px; padding: 3px 2px;">Hoạt động tốt</th>
              <th style="border: 1px solid black; width: 55px; padding: 3px 2px;">Hư hỏng</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px;">Ghi chú</th>
            </tr>
          </thead>
          <tbody>
            ${assets.map(asset => `
              <tr style="height: 20px; vertical-align: middle;">
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px;">${asset.stt}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px; font-weight: ${asset.stt <= 5 ? 'bold' : 'normal'}">${asset.hangMuc}</td>
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px;">${asset.tongSo}</td>
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px; color: green; font-weight: bold;">${asset.hoatDongTot}</td>
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px; color: ${parseInt(asset.huHong) > 0 ? 'red' : 'black'}; font-weight: ${parseInt(asset.huHong) > 0 ? 'bold' : 'normal'}">${asset.huHong}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px; font-style: italic; font-size: 9pt; color: #333;">${asset.ghiChu}</td>
              </tr>
            `).join('')}
          </tbody>
        </table>
        ...
        <table style="width: 100%; border: 1px solid black; border-collapse: collapse; font-size: 9.5pt; color: black; margin-bottom: 12px; page-break-inside: avoid;">
          <thead>
            <tr style="background-color: #f2f2f2; font-weight: bold; text-align: center; height: 24px;">
              <th style="border: 1px solid black; width: 35px; padding: 3px 2px;">STT</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px; width: 130px;">Thiết bị</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px; width: 110px;">Vị trí/Máy số</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px;">Hiện trạng</th>
              <th style="border: 1px solid black; text-align: center; padding: 3px 4px; width: 100px;">Mức độ</th>
            </tr>
          </thead>
          <tbody>
            ${brokenDetails.length === 0 ? `
              <tr>
                <td colspan="5" style="border: 1px solid black; text-align: center; padding: 8px; font-style: italic; color: #555;">Không có thiết bị hư hỏng ghi nhận.</td>
              </tr>
            ` : brokenDetails.map(row => `
              <tr style="height: 20px; vertical-align: middle;">
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px;">${row.stt}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px; font-weight: bold;">${row.thietBi}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px;">${row.viTri}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px; color: #333;">${row.hienTrang}</td>
                <td style="border: 1px solid black; text-align: center; padding: 2px 4px; font-weight: bold; color: ${row.mucDo.includes('thay mới') ? '#d97706' : '#2563eb'}">${row.mucDo}</td>
              </tr>
            `).join('')}
          </tbody>
        </table>
        ...
        <table style="width: 100%; border: 1px solid black; border-collapse: collapse; font-size: 9.5pt; color: black; margin-bottom: 16px; page-break-inside: avoid;">
          <thead>
            <tr style="background-color: #f2f2f2; font-weight: bold; text-align: center; height: 24px;">
              <th style="border: 1px solid black; width: 35px; padding: 3px 2px;">STT</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px; width: 150px;">Thiết bị</th>
              <th style="border: 1px solid black; text-align: center; padding: 3px 4px; width: 85px;">Số lượng</th>
              <th style="border: 1px solid black; text-align: left; padding: 3px 6px;">Lý do</th>
            </tr>
          </thead>
          <tbody>
            ${additions.length === 0 ? `
              <tr>
                <td colspan="4" style="border: 1px solid black; text-align: center; padding: 8px; font-style: italic; color: #555;">Không đề xuất thêm thiết bị bổ sung.</td>
              </tr>
            ` : additions.map(row => `
              <tr style="height: 20px; vertical-align: middle;">
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px;">${row.stt}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px; font-weight: bold;">${row.thietBi}</td>
                <td style="border: 1px solid black; text-align: center; padding: 2px 3px; font-weight: bold; color: #16a34a;">${row.soLuong}</td>
                <td style="border: 1px solid black; text-align: left; padding: 2px 6px;">${row.lyDo}</td>
              </tr>
            `).join('')}
          </tbody>
        </table>
        ...
        <table style="width: 100%; border: none; border-collapse: collapse; margin-top: 15px; color: black; page-break-inside: avoid;">
          <tr>
            <td style="width: 45%; text-align: center; padding: 0;"></td>
            <td style="width: 55%; text-align: center; padding: 0; vertical-align: top;">
              <div style="font-style: italic; font-size: 10.5pt; margin-bottom: 3px;">Long Định, ngày ${ngayKy} tháng ${thangKy} năm 20${namKy.replace(/^20/, '')}</div>
              <div style="font-weight: bold; font-size: 10.5pt; text-transform: uppercase;">Người lập báo cáo</div>
              <div style="font-size: 9.5pt; font-style: italic; color: #555; margin-top: 2px; margin-bottom: 45px;">(Ký, ghi rõ họ tên)</div>
              <div style="font-weight: bold; font-size: 11pt; text-decoration: none;">${generalInfo.nguoiPhuTrach}</div>
            </td>
          </tr>
        </table>
      </div>
  ...
  // 1. DIRECT PRINT IMPLEMENTATION (POPUP & NATIVE WINDOW PRINT)
      ...
      if (printWin) {
        ...
        printWin.document.write(`
          ...
          <html>
            <head>
              <meta charset="utf-8">
              <title>Báo cáo CSVC Phòng máy tính - Trường TH Long Định</title>
              <style>
                @media print {
                  @page {
                    size: A4 portrait;
            ...
            <body>
              <div style="margin-bottom: 20px; text-align: right;" class="no-print">
                <button onclick="window.focus(); window.print();" class="btn-print-top">🖨️ KẾT NỐI MÁY IN & IN BÁO CÁO NGAY (CTRL + P)</button>
              </div>
              <div>
        ...
        showToast('Đang kết nối máy in qua cửa sổ in chuẩn A4...', 'success');
        return true;
      }
    } catch (err) {
      console.warn('Popup window blocked, falling back to full print mode:', err);
    }
    return false;
  };

  const handlePrint = () => {
    // If user is already in A4 full-page print mode, call native window.print() directly
    if (isPrintMode) {
      showToast('Đang kết nối máy in & mở hộp thoại in...', 'success');
      window.focus();
      window.print();
      return;
    }

    // Try popup print window first
    const popupSuccess = handleOpenPrintWindow();
    if (!popupSuccess) {
      // Switch into full-screen print view & trigger print
      setIsPrintMode(true);
      showToast('Đang chuyển chế độ in & kết nối máy in...', 'success');
      setTimeout(() => {
        window.focus();
        window.print();
      }, 400);
    ...
    return (
      <div className="min-h-screen bg-[#f1f5f9] py-10 print:py-0 print:bg-white flex justify-center items-start relative z-50 animate-fadeIn">
        ...
        <div className="fixed top-4 right-4 z-[9999] bg-slate-900/95 text-white px-5 py-3 rounded-2xl shadow-2xl border border-slate-700/80 backdrop-blur-md flex items-center gap-3.5 no-print print:hidden">
          ...
          <button
            onClick={handlePrint}
            className="btn-3d btn-3d-emerald text-xs px-4 py-2 uppercase tracking-wider"
            title="Kích hoạt hộp thoại in trực tiếp của trình duyệt"
          >
          ...
          <button
            ...
            className="btn-3d btn-3d-purple text-xs px-4 py-2 uppercase tracking-wider"
            title="Mở báo cáo trong cửa sổ riêng để in dễ dàng"
          >
            <ExternalLink className="w-3.5 h-3.5" />
            <span>Mở Cửa Sổ In</span>
          </button>
          
          <button
            onClick={handleExportWord}
            className="btn-3d btn-3d-blue text-xs px-4 py-2 uppercase tracking-wider"
          ...
          <button
            ...
            className="btn-3d btn-3d-rose text-xs px-4 py-2 uppercase tracking-wider"
          ...
          <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-3xs flex flex-wrap items-center justify-between gap-3 text-left">
            ...
            <div className="flex flex-wrap items-center gap-1.5 md:gap-2">
              ...
              <button
                ...
                className="btn-3d btn-3d-emerald text-[11px] px-3.5 py-1.5 uppercase tracking-wider"
              ...
              <button
                onClick={handlePrint}
                className="btn-3d btn-3d-blue text-[11px] px-3.5 py-1.5 uppercase tracking-wider"
              ...
              <button
                ...
                className="btn-3d btn-3d-purple text-[11px] px-3.5 py-1.5 uppercase tracking-wider"
              ...
              <button
                onClick={handleExportWord}
                className="btn-3d btn-3d-teal text-[11px] px-3.5 py-1.5 uppercase tracking-wider"
