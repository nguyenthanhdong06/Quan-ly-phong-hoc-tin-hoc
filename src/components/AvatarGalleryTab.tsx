        ...
        <div className="lg:col-span-4 bg-white p-4 rounded-2xl border border-slate-100 shadow-xs flex flex-col space-y-3">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs rounded-xl pl-8 pr-8 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all font-semibold"
            />
            {studentSearchQuery && (
              <button
                type="button"
