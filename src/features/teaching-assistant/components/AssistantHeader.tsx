...
export const AssistantHeader: React.FC<AssistantHeaderProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Banner Tiêu đề & Nút hành động - Tinh gọn, thanh thoát */}
      <div className="bg-gradient-to-r from-[#dfccb0] via-[#e8d9c2] to-[#dfccb0] border border-[#cbb89d] rounded-xl px-3.5 py-2.5 sm:px-4 sm:py-2.5 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-2.5 sm:gap-3">
        <div>
          <div className="flex items-center gap-2.5 flex-wrap">
            <span className="w-8 h-8 rounded-lg bg-amber-500 text-amber-950 flex items-center justify-center shadow-xs shrink-0">
              <CheckSquare className="w-4.5 h-4.5 stroke-[2.5]" />
            </span>
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-base sm:text-lg font-black text-[#3d2b17] tracking-tight leading-none">
                  Trợ lý công việc giảng dạy
                </h1>
                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-amber-200/90 text-amber-900 border border-amber-300 leading-none">
                  DeskOS Assistant
                </span>
              </div>
              <p className="text-[11px] sm:text-xs font-semibold text-[#5c4327] mt-1 flex items-center gap-2 flex-wrap leading-tight">
                <span>Quản lý kế hoạch bài dạy, đối chiếu TKB và nhắc việc tự động</span>
                <span className="hidden sm:inline text-[#cbb89d]">•</span>
                <span className="inline-flex items-center gap-1 font-bold text-emerald-900 bg-emerald-100/80 px-1.5 py-0.5 rounded text-[11px] border border-emerald-300">
        ...
        {/* Cụm nút Thao tác nhanh gọn nhẹ */}
        <div className="flex items-center gap-2 w-full md:w-auto shrink-0">
          <button
            type="button"
            onClick={onOpenQuickNoteModal}
            className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg font-bold text-xs bg-gradient-to-b from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-amber-950 shadow-xs border border-amber-600/40 active:scale-95 transition cursor-pointer"
          ...
          <button
            ...
            className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg font-bold text-xs bg-[#3d2b17] hover:bg-[#2a1d0f] text-[#fffbf0] shadow-xs border border-[#2a1d0f] active:scale-95 transition cursor-pointer"
          >
